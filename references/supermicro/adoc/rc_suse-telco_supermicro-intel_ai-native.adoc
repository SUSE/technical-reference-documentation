...
* Apply the CAPI manifests to provision the host with the operating system and RKE2 cluster as well as all Telco capabilities like kernel args, sriov, cpuisolation, and so on.
//
+
