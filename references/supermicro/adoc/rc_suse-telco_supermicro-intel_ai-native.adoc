...
The 1U {smss-long} is designed for telco edge applications.
Its key features include:

* {cpu}
* Up to 4 DIMMs, supporting up to 512 GB DDR5-6400 RAM
* Up to 2 PCIe 5.0 x16 FHHL slots
* 8 SFP28 25 GbE LAN ports and 1 RJ45 GbE LAN port
* 2 SMA for 1PPS (1 Input 1 Output)
* 1 SMA for GNSS input with onboard GNSS module

image::supermicro-112D-front.png[title="Supermicro {smss112-mode} front view", Supermicro {smss112-mode} front view, align="center",width=90%]


Supermicro offers both 1U and 2U options.
