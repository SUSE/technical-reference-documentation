...
For more information, see the {stelco-docs-arch}[{stelco} Architecture].

Key capabilities of {stelco} include:

. Key {stelco} capabilities
[%unbreakable]
[cols="1,2"]
|===
...
At the time of publication, choose the `SL-Micro.x86_64-6.1-Base-GM.raw.xz` image file.
