...
. Add your {kiwi} ISO image (output from kiwi process) as a base-image in the `base-images` folder. To do that you can follow the steps in the {stelco-docs-kiwi-builder}[full guide instructions in official docs].
...
image::8.1.4-rancher-ui-1.png[align="center",width=90%]

image::8.1.4-rancher-ui-2.png[align="center",width=90%]
...
image::8.1.4-rancher-ui-3.png[align="center",width=90%]

image::8.1.4-rancher-ui-4.png[align="center",width=90%]
...
image::9.2-latency-plot.png[align="center",width=90%]
