...
Supermicro SYS-112D-42C-FN8P front view

image::media/src/png/Supermicro-system-front-view.png[align="center",width=90%]

Supermicro SYS-112D-42C-FN8P  back view
...
the structure and files content described in official docs:
...
images folder. To do that you can follow the steps in the [full guide instructions in official docs](https://documentation.suse.com/suse-edge/3.4/html/edge/guides-kiwi-builder-images.html)
...
`-- network
 ...
 . Add your KIWI iso image (output from kiwi process) as a base-image in the base-images folder. To do that you can follow the steps in the [full guide instructions in official docs](https://documentation.suse.com/suse-edge/3.4/html/edge/guides-kiwi-builder-images.html)
...
==== Intro
Directed network provisioning (https://documentation.suse.com/suse-edge/3.4/html/edge/atip-automated-provisioning.html) is a feature that allows you to automate the provisioning of downstream clusters. This feature is useful when you have many downstream clusters to provision, and you want to automate the process.

==== Cluster API & SUSE Telco Cloud
Cluster API (CAPI)(https://documentation.suse.com/suse-edge/3.4/html/edge/quickstart-metal3.html#id-high-level-architecture-2) enables management of infrastructure resources across multiple infrastructure providers via broadly adopted vendor-neutral APIs.
