...
:kiwing-docs: https://osinside.github.io/kiwi/

:suse-linux-micro-image-with-kiwi: https://documentation.suse.com/suse-edge/3.4/html/edge/guides-kiwi-builder-images.html
:suse-telco-automated: https://documentation.suse.com/suse-edge/3.4/html/edge/atip-automated-provisioning.html#
:suse-telco-high-level-arc: https://documentation.suse.com/suse-edge/3.4/html/edge/quickstart-metal3.html#id-high-level-architecture-2
:xeon-processor-networking: https://www.intel.com/content/www/us/en/products/details/processors/xeon/edge.html
:suse-telco-web: https://documentation.suse.com/suse-edge/3.4/html/edge/atip.html
