...
Additionally, the author would like to thank the {hitachivsp-provider} engineering teams for their validation and joint testing of the {hspc-long} integration with {svirt}.
