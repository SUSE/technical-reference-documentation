...
Adding the Fortinet deployment, it is the same workflow as with the normal SUSE SAP automation project, you only need to enable “with fortinet” to benefit from the additional installation of the Fortinet Fabric.
...
Everybody who want to try out the solution.
