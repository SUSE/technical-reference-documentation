...
:usecase: Move from a free openSUSE Leap to a SUSE Linux Enterprise Distribution

:executive_summary: This document provides a brief showcase how to migrate from a free linux to a PAYG enterprise distribution in Azure.
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
Since version 15.3 it is simple to migrate from openSUSE Leap to SLES, and with version 15.4+ it is much more simple.
