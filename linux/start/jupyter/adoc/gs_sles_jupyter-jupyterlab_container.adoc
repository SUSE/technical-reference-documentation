...
To be successful with this guide, you will need to understand a few technical areas.

* https://www.python.org/[Python]: Know a little about the language tools that are used here.

* https://www.suse.com/products/server/[SLES]: Have access to a SUSE Linux Enterprise Server operating system.

* https://jupyter.org/[JupyterLab]: Have access to a SUSE Linux Enterprise Server operating system.

If you need to review how to work with JupyterLab, see
