...
You need a directory to contain the files you need for building your container image.
...
=== Specify the Python packages you need in the container
...
The resulting file access permissions problems can introduce friction to your development workflows.

You can address this issue by running a script in the container that creates a user account with a matching UID and switches to this user to run your workload.

Create this _entrypoint.sh_ script file in your build directory:
...
RUN . /home/virtualenv/bin/activate && pip install -r requirements.txt
...
For this guide, you use the 'latest' https://documentation.suse.com/container/all/single-html/SLES-container/#cha-bci[base container image].


Some important considerations when choosing a base container image include:

Security::
Is the image from a trusted source, verifiable, and up-to-date with vulnerability fixes?

Stability::
Has it undergone quality assurance testing?

Tooling and integration::
Are you able to use it with your preferred tooling and workflow?

Redistribution::
Are you legally able to redistribute your custom application container images built on it?
