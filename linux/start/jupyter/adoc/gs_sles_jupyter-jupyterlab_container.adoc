...
Once the files are received, the recipient can follow the same steps you used to create the container image and run the container.
...
* Content types: Do you need to store more artifacts than just a container image?
