...
:description-social: {jup} with {bci-full}

:executive-summary: Accelerate development and production in data analytics, machine learning, and artificial intelligence with {bci-full} and {jup}.
