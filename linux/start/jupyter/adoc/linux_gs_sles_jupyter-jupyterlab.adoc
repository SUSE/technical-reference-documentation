...
The {productname} software repositories include many of these Python packages, tested against the included version of Python.
+
// TS: Can we include some kind of statement about SUSE support here?
+
These Python packages are perfect if the version matches what you need for your project and you are installing system-wide.
...
In PyPI, you can find more Python software packages and package versions.

The Python `pip` command is the preferred installer for Python packages from PyPI as well as other package indexes.
In this guide, you will use the `pip` command to install packages from PyPI into your active virtual environment and not system-wide.
See the https://pip.pypa.io/en/stable/[pip documentation] for more features of this powerful tool.



. Make sure yourRun the following commands as your user:
