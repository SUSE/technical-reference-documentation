...
----
+
JupyterLab fills your terminal window with some helpful information, like the following:
+
[source, bash]
----
...
[C 2022-08-22 13:14:26.398 ServerApp] 
    ...
    To access the server, open this file in a browser:
        file:///home/terry/.local/share/jupyter/runtime/jpserver-31811-open.html
...
[NOTE]
====
As you can see in the command output, JupyterLab uses an access token to authenticate you to the web UI.
This token is unique to each instance of the environment.
====

. Access the JupyterLab environment.
JupyterLab is web-based and attempts to open the default web browser to the user interface.
If no default web browser is configured or fails to open, you can find the use one of the helpful access suggestions shown in your command terminal.
+
[TIP]
====
If your environment is on a remote, headless host, you can use SSH port forwarding to gain access.

. Log into the remote host, creating a local port forward.
+
[source, bash]
----
...
. Open the web browser on your local system to the URL specified in your command terminal.
====
...
// TS (20220822): Brian, would you be able to write a quick overview of the parts of the JupyterLab UI?
