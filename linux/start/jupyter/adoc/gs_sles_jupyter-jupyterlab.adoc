...
=== Exploring the JupyterLab user interface
...
The main JupyterLab interface consists of a main work area, a collapsible sidebar on the left, and a menu at the top.

image::jupyterlab_ui_001.png[JupyterLab UI Launcher, scaledwidth="85%", align="center"]

JupyterLab opens with the Launcher in a tab in the main work area.
It is from the Launcher that you can launch a notebook, console, terminal window, and more.

From the sidebar, you access and manage files, managed running kernels, and so on.

Access additional functions through the top menu, such as managing running processes, kernels, and tabs.
