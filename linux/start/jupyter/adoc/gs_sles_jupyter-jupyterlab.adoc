...
Once you have a requirements file, you can share it with another developer or use it yourself to make sure a new environment contains all the same packages.
...
* JupyterHub: the multi-user version of Jupyter Notebook that enables companies, classrooms, and research labs to deliver computational environments and resources to users while managing them centrally.
...
[NOTE]
====
If you select __Logout__ from the __File__ menu or just close your browser, the JupyterLab environment continues to run.
...
The fast pace of ML development is largely due to collaboration between individuals, teams, and the wider community.
JupyterLab provides a great environment for experimentation, and the notebook format provides an easy mechanism for sharing your code with others.
...
Whether you are just getting started on your machine learning journey or already looking to scale to production, start from a capable, adaptable, and supported foundation with SUSE Linux Enterprise.

In this guide, you learned:

* to isolate your Python projects in virtual environments.
* to manage Python packages.
* to simplify replicability and sharing.
* to deploy JupyterLab for a self-documenting, interactive development environment.
