...
If you would like to explore registering client systems for management, add one or more additional systems.
...
End customers may have access to their own {product1} servers if they wish.
...
A customer who is able to access the hub would be able to access other customers' systems.
====
