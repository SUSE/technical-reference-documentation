...
----
+
<1> Logging information will be written to `/var/log/hpcr.log`.
...
----
+
<1> where <github user> and <github token> are for your personal GitHub account. 
...
----
+
<1> Be sure to replace `<macaddress>` in this command with the MAC address you noted in the previous step.
