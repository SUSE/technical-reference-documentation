...
// * https://documentation.suse.com/trd/linux/tbd[Build] a trusted PayNow Web site container on {product1_full} using https://cloud.ibm.com/docs/vpc?topic=vpc-about-hpsb[{hpp} Secure Build].
