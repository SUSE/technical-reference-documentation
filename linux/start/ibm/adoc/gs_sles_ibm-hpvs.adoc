...
Confidential computing focuses on enabling you to secure your data with technologies and techniques.
With confidential computing, you can protect your data anywhere, whether your workload is running your own data center or in the data center of a service provider.

SUSE and IBM have a long history of working together to deliver advanced technical capabilities, like confidential computing.
IBM Z(R) and LinuxONE systems provide key hardware capabilities for a trusted execution environment to protect your data while in use.
{product1_url}[{product1_full}] enables secure execution in the kernel and in userspace.
Together, these technologies help you ensure confidentiality and integrity for your sensitive workload data.

Container technologies facilitate unprecedented agility, resilience, and scale.

Containers are an essential component to modern, enterprise computing.
...
Contributions to the development of this guide by the following individuals is greatly appreciated:
