...
The https://registry.suse.com/categories/bci-lang[SLE BCI Language Container Image] for Node.js is used as base for the PayNow Node.js application container image.
