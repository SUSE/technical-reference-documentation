...
The https://registry.suse.com/[SLE BCI Language Container Images] for Node.js development is used as base for the PayNow Node.js application container image.
