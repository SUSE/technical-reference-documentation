...
image::TRD-Kubernetes-ss-mongodb-1.png[scaledwidth="75%", align="center"]
...
image::TRD-Kubernetes-ss-mongodb-2.png[scaledwidth="75%", align="center"]
...
image::TRD-Kubernetes-ss-mongodb-3.png[scaledwidth="75%", align="center"]
