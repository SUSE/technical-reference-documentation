...
We strongly recommend disallowing the predefined rule __Suspicious Container Activity__ before adding the new rule (__Policies__ > __Runtime Policies__ > __Suspicious Container Activity__).
