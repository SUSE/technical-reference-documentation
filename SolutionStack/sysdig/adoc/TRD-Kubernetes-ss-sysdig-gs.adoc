...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-view-audit.png[scaledwidth="65%", align="center"]
+
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-view-capture-1.png[scaledwidth="50%", align="center"]
