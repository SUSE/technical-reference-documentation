...
image::TRD-Kubernetes-ss-sysdig-gs-image-install-1[scaledwidth="75%", align="center"]
image::TRD-Kubernetes-ss-sysdig-gs-image-install-2[scaledwidth="75%", align="center"]
