...
// = {title}
= Sysdig Secure DevOps Platform with SUSE Rancher: Getting Started Guide

// SUSE Rancher - Sysdig Secure DevOps Platform
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-marketplace-overview.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-marketplace.png[scaledwidth="85%", align="center"]

.. Specify a namespace.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-install-1.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-install-2.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-Runtime-Policies.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-choose-policy.png[scaledwidth="85%", align="center"]

.. In the __New Policy__ screen, enter a name and a description.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-new-policy-name.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-policy-scope.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-import.png[scaledwidth="85%", align="center"]

.. Find and select __Terminal shell in a container__ from the __Rules Library__, then click __Import Rules__.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-rules-library.png[scaledwidth="85%", align="center"]

.. You should now see the __Terminal shell in a container__ rule assigned to your policy.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-rule-config.png[scaledwidth="85%", align="center"]
...
+
Your email is the default notification channel, but you can configure additional options under __Settings__ > __Notification Channels__.
For example, you can choose to send notifications to a Slack Channel.
You can also leave this blank.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-actions-config.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-capture-config.png[scaledwidth="85%", align="center"]

. Create the policy by clicking __Save__.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-save-policy.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-open-terminal-shell-from-rancher-ui-1.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-open-terminal-shell-from-rancher-ui-2.png[scaledwidth="85%", align="center"]
...
. Click __Events__.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-events.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-event-details.png[scaledwidth="85%", align="center"]

. Dig deeper by clicking __Respond__ at the top of this panel and selecting __View Activity Audit__.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-view-audit.png[scaledwidth="85%", align="center"]
+
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-activity-audit.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-view-capture-1.png[scaledwidth="85%", align="center"]

. Click the shovel icon to the right of the "Terminal shell in a container" capture file to open it with Sysdig Inspect.
+
image::TRD-Kubernetes-ss-sysdig-gs-image-view-capture-2.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-Inspect.png[scaledwidth="85%", align="center"]
...
+
image::TRD-Kubernetes-ss-sysdig-gs-image-IO-streams-capture.png[scaledwidth="85%", align="center"]
