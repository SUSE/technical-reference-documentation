...
ifdef::RA[]
+
[[g-ra,reference architecture]] Reference Architectures footnote:Reference-Architecture[link: https://en.wikipedia.org/wiki/Reference_architecture[Reference Architecture]]::
...
+
[[g-automation,Automation]]Automation footnote:Automation[link: https://en.wikipedia.org/wiki/Infrastructure_as_code[Infrastructure-as-Code]]::
...
+
[[g-availability,Availability]]Availability footnote:Availability[link: https://en.wikipedia.org/wiki/Minimum_viable_product[Availability]]::
...
+
[[g-integrity,Integrity]]Integrity footnote:Integrity[link: https://en.wikipedia.org/wiki/Data_integrity[Data Integrity]]::
...
+
[[g-performance,Performance]]Performance footnote:Performance[link: https://en.wikipedia.org/wiki/Performance_engineering[Performance Engineering]]::
...
ifdef::FCTR+Security[]
+
[[g-security,Security]]Security footnote:Security[link: https://en.wikipedia.org/wiki/Security[Security]]::
...
+
ifdef::FLVR+PoC[]
[[g-poc,proof-of-concept]]Proof-of-Concept footnote:Proof-of-Concept[link: https://en.wikipedia.org/wiki/Proof_of_concept[Proof of Concept]]::
