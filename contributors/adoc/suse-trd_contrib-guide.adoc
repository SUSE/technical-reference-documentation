...
** Use the https://github.com/openSUSE/daps2docker[DAPS2Docker] container implementation with core rendering functionality and the latest https://github.com/openSUSE/suse-xsl[SUSE XSL Stylesheets].
