...
Other block elements include sections, lists, tables, image macros, listing blocks, source blocks, and admonitions.
Thus, an image or a source block is treated by the rendering engine somewhat like a paragraph.
