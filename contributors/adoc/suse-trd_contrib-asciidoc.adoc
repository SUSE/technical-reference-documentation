...
By simply placing a backslash ( `\` ) just before each of the curly braces, you designate the curly braces as literal characters.
...
.. Select __myfile__ from the list.
