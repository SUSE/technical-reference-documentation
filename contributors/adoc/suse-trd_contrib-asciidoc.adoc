...
Block elements (or blocks) are discrete, line-oriented chunks of content that form the basic structure of your AsciiDoc document.
...
Blocks are defined with a line-oriented syntax.
