...
// -
:title: My Tuxy Project
:subtitle: Demonstrate SUSE TRD Contributor Workflow
:productname: SUSE TRD
:platform1: SUSE Technical Reference Documentation
//:otherproduct1: None
:usecase: contribute to SUSE TRD
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
:author1_jobtitle: Director, Global Partner Solutions
