...
// TODO: clean this up so it's not a direct copy of the webiste
...
To utilize SUSE Security data in Microsoft Sentinel, this guide outlines the steps to export data from SUSE Security into a Syslog server and then collecting it into an Azure Log Analytics Workspace. This data will then be used in Microsoft Sentinel. The following diagram provides a basic overview of the data flow. 
