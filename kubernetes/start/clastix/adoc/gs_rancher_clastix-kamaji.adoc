...
//
+
You can follow this guide with {comp1-website}[{comp1}] {comp1-version1} or later, which enables support for {comp1-docs}}integrations-in-rancher/rancher-extensions[Rancher Extensions].
...
After a tenant cluster is created, you can import it into {comp1-website}[{comp1-full}] for centralized management of your Kubernetes landscape.
...
{comp2-full} is available through the Rancher App catalog.
...
In addition, {comp2-provider} has created a {comp1} Extension.
{comp1} Extensions allow users, developers, partners, and customers to extend and enhance the {comp1} UI.


=== Install the Kamaji Operator
...
=== Verify installatio of Kamaji Operator and Console

Verify that the Kamaji Operator and Kamaji Console are installed.

. In the {comp1}} UI, make sure you have selected the Kamaji Admin Cluster.
...
=== Install Kamaji {comp1} UI Extension

{comp1-docs}integrations-in-rancher/rancher-extensions[Rancher extensions] allow users, developers, partners, and customers to extend and enhance the {comp1} UI.
...
.. With the Kamaji extension installed, the {comp1} UI includes a new __Multitenancy Management__ menu option for each managed cluster.
+
...
== Import the tenant cluster into {comp1-full}

Bring your tenant clusters into {comp1-full} for unified management and oversight of your Kubernetes landscape.
...
In this guide, you learned how to seamlessly deploy {comp2-full} into your {comp1-full} Kubernetes landscape, create tenant clusters, and import them into Rancher for unified and streamlined management.
