...
[NOTE]
====
*Mark*: Let's add this to a separate file and link it here.
====
...
It would be based on Alex's instructions: https://gist.github.com/alexarnoldy/24dd06d8c4291d04c5d7065b520bcb15.
====
...
[NOTE]
====
*Mark*: Kubeflow relies on Istio in production.
We need to address this.
I would recommend creating this section in a separate file and linking it here.
====
...
We should render the installation steps here.
====
...
[NOTE]
====
*Mark*: I've moved these instructions into another file (kubernetes-tls-cert.adoc) and include them here (see below everything I commented out) to illustrate what we can do with other sections.
====
...
include::kubernetes-tls-cert.adoc[]


=== Add the TLS secret to Istio

[NOTE]
====
*Mark*: We should move this into another file and include it here, as above.
Also could we clarify where some of the manifest content should go.
====
