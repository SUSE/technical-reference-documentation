...
* https://www.suse.com/products/suse-rancher/[SUSE Rancher] is an enterprise Kubernetes and container management platform that allows you to deploy workloads anywhere - at the data center core, in the cloud, and even at the edge - efficiently and with enterprise-grade security and support.
...
Following this guide, you use Rancher to deploy {partnerproductname}, a stock prediction Web application, which you can obtain from the project's https://github.com/navin772/GSOC_Stock_prediction/tree/master/fin_dashboard[code repository].
{partnerproductname} is discussed in more detail later on.
...
----
+
Replace <USERNAME> with your DockerHub user name.
...
[TIP]
====
Be sure you log in to your https://hub.docker.com/[DockerHub] account before pushing the image.
