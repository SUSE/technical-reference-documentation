...
:title: MongoDB Enterprise with SUSE Rancher: Getting Started
:productname: SUSE Rancher 2.5
:author1: Samip Parikh, Solution Architect, SUSE
:revdate: April 20, 2021
:revnumber: 20210420
//:toc2:
//:toc-title: {title}
//:toclevels: 4
...
This guide will introduce some general concepts and basic steps for installing, configuring, and using MongoDB Enterprise in a SUSE Rancher Kubernetes environment.
...
This document is intended for developers, DevOps, and IT professionals who are responsible building, managing, and using a cloud native, agile data platform, featuring MongoDB and SUSE Rancher.
...
Rancher solves a common issue in the Kubernetes community: installation complexity.
With Rancher, Kubernetes installation is simplified, 
...
Rancher has the capability to manage any Kubernetes cluster from a central location, via the Rancher server.
As illustrated below, Rancher can manage any Kubernetes flavor and is not restricted to RKE.

image::kubernetes_gs_rancher_mongodb-enterprise_image_2.png[scaledwidth="75%", align="center"]
...
image::kubernetes_gs_rancher_mongodb-enterprise_image_3.png[scaledwidth="75%", align="center"]
