...
:comp3-docs: https://documentation.suse.com/sle-micro/{comp1-version1}
...
:author2-firstname: Gopala Krishnan
:author2-surname: A
:author2-jobtitle: Solution Architect
