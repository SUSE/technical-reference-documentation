...
Step 1) Create a new namespace for the Kasten K10 application.  

Navigate to “Clusters” -> “Project/Namespaces” 

image::kubernetes_gs_rancher_veeam-kasten_image_step1-1.png[scaledwidth="85%", align="center"]

•  Create a new namespace for Kasten K10 called “kasten-io”.

image::kubernetes_gs_rancher_veeam-kasten_image_step1-2.png[scaledwidth="85%", align="center"]

Step 2) Install Kasten K10
•  Navigate to “Apps & Marketplace” -> “Charts” within the SUSE Rancher web interface and search for “Kasten”.

image::kubernetes_gs_rancher_veeam-kasten_image_step2-1.png[scaledwidth="85%", align="center"]

•  Click the K10 chart and then click “Install”.

image::kubernetes_gs_rancher_veeam-kasten_image_step2-2.png[scaledwidth="85%", align="center"]

•  Set the namespace to “kasten-io” and check the box “Customize Helm Options”.

image::kubernetes_gs_rancher_veeam-kasten_image_step2-3.png[scaledwidth="85%", align="center"]

The chart values screen “Install: Step 2” – allows for customization of the Kasten K10 deployment. This is a necessary set depending on the Kubernetes distribution to which you are installing.  For a detailed explanation of the installation options available see https://docs.kasten.io/latest/install/advanced.html#complete-list-of-k10-helm-options.

image::kubernetes_gs_rancher_veeam-kasten_image_step2-4.png[scaledwidth="85%", align="center"]

After setting your chart values, click next to go the Step 3.  Accept the default values and click “Install” to being the installation of Kasten K10.

image::kubernetes_gs_rancher_veeam-kasten_image_step3-1.png[scaledwidth="85%", align="center"]
...
In the unlikely scenario that pods that are stuck in any other state, please follow the https://docs.kasten.io/latest/operating/support.html#support[support] documentation to debug further.
...
•  https://docs.kasten.io/latest/access/gcp_details/gcp_console_dashboard.html [K10 Dashboard Directly From the Google Cloud Console]
...
image::kubernetes_gs_rancher_veeam-kasten_image_kasten_signin-1.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-1.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-2.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-3.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-4.png[scaledwidth="85%", align="center"]

//kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-5
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-5.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-6.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-7.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-8.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-9.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-10.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-11.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-12.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-13.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-14.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-15.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-16.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-17.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-18.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-19.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-20.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-21.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-22.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-23.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-24.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-25.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-26.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-27.png[scaledwidth="85%", align="center"]

//kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-28
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-28.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-29.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-30.png[scaledwidth="85%", align="center"]
...
image::kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-31.png[scaledwidth="85%", align="center"]
