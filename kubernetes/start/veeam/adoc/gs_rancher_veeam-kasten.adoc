...
The Advanced Options settings enable selecting how many times and when actions are executed within the interval of the frequency.
As an example, for a daily frequency, you can set the hour or hours within each day and the minute within each hour.
