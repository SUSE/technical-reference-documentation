...
+
image::rancher_veeam-kasten_k10_2_create-namespace.png[scaledwidth="85%", align="center"]

. Install Kasten K10.

.. Navigate to __Apps & Marketplace__ > __Charts__ within the SUSE Rancher UI and search for “Kasten.”
+
image::rancher_veeam-kasten_k10_3_marketplace1.png[scaledwidth="85%", align="center"]
//image::rancher_veeam-kasten_step2-1.png[scaledwidth="85%", align="center"]

.. Select the K10 chart and then click __Install__.
+
image::rancher_veeam-kasten_k10_4_marketplace2.png[scaledwidth="85%", align="center"]
...
+
image::rancher_veeam-kasten_k10_5_marketplace3.png[scaledwidth="85%", align="center"]
...
image::rancher_veeam-kasten_k10_6_token-login1.png[scaledwidth="50%", align="center"]
...
image::rancher_veeam-kasten_k10_7_dashboard-welcome.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_8_dashboard_overview-top.png[scaledwidth="85%", align="center"]
...
image::rancher_veeam-kasten_k10_9_dashboard-apps1.png[scaledwidth="85%", align="center"]
...
image::rancher_veeam-kasten_k10_10_dashboard-apps2.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_11_dashboard-policies.png[scaledwidth="85%", align="center"]
...
image::rancher_veeam-kasten_k10_12_location-profiles1.png[scaledwidth="65%", align="center"]
...
image::rancher_veeam-kasten_k10_13_location-profiles2.png[scaledwidth="40%", align="center"]
...
Once you click __Validate and Save__, the config profile will be created and a profile similar to the following will appear:

//kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-9: location profiles
image::rancher_veeam-kasten_k10_13_location-profiles3.png[scaledwidth="85%", align="center"]
...
While you can always create a policy from scratch through the Policies page, the easiest way to define policies for unprotected applications is to click on the __Applications__ card in the main dashboard.
...
image::rancher_veeam-kasten_k10_14_backup-frequency.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_15_export-frequency.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_16_snapshot-retention-schedule.png[scaledwidth="65%", align="center"]
...
image::rancher_veeam-kasten_k10_17_backup-retention-schedule.png[scaledwidth="65%", align="center"]
...
image::rancher_veeam-kasten_k10_18_timing.png[scaledwidth="75%", align="center"]
...
//kubernetes_gs_rancher_veeam-kasten_image_k10_19_timing-snapshot-retention: snapshot retention
image::rancher_veeam-kasten_k10_19_timing-snapshot-retention.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_21_app-selection-by-name-wildcard.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_24_app-selection-by-label.png[scaledwidth="75%", align="center"]
...
You can further customize what is and what isn't covered under a K10 application protection policy with:
...
image::rancher_veeam-kasten_k10_25_policy-activity.png[scaledwidth="85%", align="center"]
...
image::rancher_veeam-kasten_k10_26_policy-detail-manual.png[scaledwidth="65%", align="center"]
...
image::rancher_veeam-kasten_k10_27_restore-app1.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_28_restore-app2.png[scaledwidth="75%", align="center"]

A restore point may include snapshots (native to the cluster) and backups (exported outside the cluster) with the same data.
When both snapshots and backups are present, the UI provides you the option to select the instance you wish to use to restore the application.

//kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-29: applications - restore - instance
image::rancher_veeam-kasten_k10_29_restore-app3.png[scaledwidth="75%", align="center"]
...
image::rancher_veeam-kasten_k10_30_restore-app4.png[scaledwidth="75%", align="center"]
...
Once the filter is in effect, you see applications that K10 has previously protected but which no longer exist.
