...
image::rancher_veeam-kasten_k10_7_location-profiles1.png[scaledwidth="65%", align="center"]
...
image::rancher_veeam-kasten_K10_8_location-profiles2.png[scaledwidth="40%", align="center"]
