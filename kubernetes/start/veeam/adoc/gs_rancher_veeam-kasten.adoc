...
NOTE: A guided tour of the K10 dashboard is available when the K10 dashboard is accessed for the first time or via the dashboard option on the https://docs.kasten.io/latest/usage/overview.html#k10-settings[Settings] page.
...
NOTE: You can filter the view by clicking on the ___Compliant__, __Non-Compliant__, or __Unmanaged__ buttons.
