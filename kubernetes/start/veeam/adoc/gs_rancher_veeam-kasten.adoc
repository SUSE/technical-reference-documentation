...
WARNING: Update this image with new branding.
...
image::rancher_veeam-kasten_kasten_signin-1.png[scaledwidth="65%", align="center"]
...
TIP: You can filter the view by clicking on the ___Compliant__, __Non-Compliant__, or __Unmanaged__ buttons.
...
// Why would this image be needed?
...
image::rancher_veeam-kasten_K10_Dashboard-12.png[scaledwidth="65%", align="center"]
...
//kubernetes_gs_rancher_veeam-kasten_image_K10_Dashboard-23 - Cluster-scoped
...
image::rancher_veeam-kasten_K10_Dashboard-26.png[scaledwidth="75%", align="center"]
...
Once you click __Restore Application__, the system will automatically recreate the entire application stack into the selected namespace.
...
Once the filter is in effect, you will see applications that K10 has previously protected but no longer exist.
...
The combination of SUSE Rancher and Kasten K10 by Veeam enable enterprises to achieve cloud native transformation goals with streamlined and unified, secure, multi-cluster Kubernetes management with Kubernetes native application backup and restore, disaster recovery, and application mobility.
