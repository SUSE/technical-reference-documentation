...
https://docs.kasten.io/latest/accecess/authentication.html#id6[Basic authentication] allows you to protect access to the K10 dashboard with a user name and password.
