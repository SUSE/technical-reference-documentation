...
You can watch the complete workflow, including a VM backup demonstration, in https://youtu.be/CrkbHHzdvv4?si=SZ070Y0ZcjfGljXD[Kubernetes Data Protection for SUSE Virtualization.]
