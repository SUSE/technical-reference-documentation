...
[NOTE]
====
For a step-by-step visual walkthrough of creating backup policies in {comp2-short} K10, refer to the demonstration video available here: https://youtu.be/c_mSNy6Q9RU.
====
