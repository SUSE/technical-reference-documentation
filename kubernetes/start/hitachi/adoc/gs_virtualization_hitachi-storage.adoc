...
//
+
The following steps can be performed on any one of the {svirt} cluster nodes.
...
//
+
Specify the storage capacity, such as 50GiB, as follows:
+
[source, yaml]
----
   apiVersion: v1
...
.. Define a VolumeSnapshotClass in `hitachi-snapclass.yaml`.
+
[source, yaml]
----
