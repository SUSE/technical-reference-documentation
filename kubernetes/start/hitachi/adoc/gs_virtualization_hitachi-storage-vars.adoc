...
:svirt-docs: https://documentation.suse.com/cloudnative/virtualization/v1.5/en/installation-setup/methods/iso-install.html

:hitachivsp-provider: Hitachi Vantara
:hitachivsp: Hitachi VSP Storage
:hitachivsp-version1:
...
:hspc: Hitachi Storage Plug-in for Containers

:hspcsi-provider: {hitachivsp-provider}
:hspcsi: HSPC CSI
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
