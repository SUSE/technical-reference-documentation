...
:author1_jobtitle: Global Solutions Architect
...
This Getting Started guide provides comprehensive instructions for two important tasks. 
...
This guide is intended for an audience comprising Kubernetes administrators, proficient DevOps practitioners, and application developers. 
It assumes a foundational understanding of Podman and/or Docker, Kubernetes, and {nvidia-name} GPU technologies. 
This guide should be suitable for most high technology professionals seeking to unlock the full potential of their GPU accelerated containerized applications.
...
These instructions leverage SUSE's security focused Kubernetes distribution, {product-rke2} {product-rke2-version}.
