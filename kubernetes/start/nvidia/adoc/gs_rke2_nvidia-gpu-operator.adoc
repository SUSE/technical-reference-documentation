...
//
+
The build host used in the development of this guide is {sles-full} {sles-version} {sles-sp-full}.
...
The process of building an OCI compliant container image with the {nvidia-drv} using {sle-bci} and deploying it to an {rke2} cluster will leverage the following primary components:
//
+
