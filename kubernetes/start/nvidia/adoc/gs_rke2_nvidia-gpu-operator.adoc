...
## Provide the required CUDA version (e.g. 12.2.2) for GPU driver by selecting your driver version at https://docs.nvidia.com/datacenter/cloud-native/gpu-operator/latest/platform-support.html
...
[IMPORTANT] 
====
The following steps must be run from a Linux system that has the kubectl and helm (version 3) utilities, as well as the KUBECONFIG file for the target Kubernetes cluster available to it. See these documents for more information: https://www.suse.com/c/rancher_blog/how-to-manage-kubernetes-with-kubectl/  https://docs.rke2.io/cluster_access 
