...
* git is installed on the build host. You can use the following command to install git.
//
+
[console, bash]
----
...
IMPORTANT: When building the container image, you may be prompted for the registry that contains the `nvidia/cuda` image. Select the image located in docker.io.
