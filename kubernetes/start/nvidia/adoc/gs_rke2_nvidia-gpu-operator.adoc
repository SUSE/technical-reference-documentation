...
NOTE: This step is optional and requires that `Podman` is installed on the target Kuberentes worker node
...
* Run the GPU operator container locally (outside of the Kubernetes cluster context):
