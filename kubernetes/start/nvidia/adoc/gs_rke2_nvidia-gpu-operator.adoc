...
Step 4: To utilize the vGPU capabilities of your datacenter grade GPU you'll need to  download both the latest "vGPU Driver Catalog" (filename vgpuDriverCatalog.yaml) and the latest "Linux KVM" package (filename "NVIDIA-GRID-Linux-KVM-*.zip").  

* To obtain these two files, sign in to your https://ui.licensing.nvidia.com/:"NVIDIA Licensing Portal" 
