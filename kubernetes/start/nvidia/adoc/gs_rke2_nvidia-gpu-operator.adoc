...
:kubectl-docs-install: https://kubernetes.io/docs/tasks/tools/install-kubectl-linux/
:helm-docs-quickstart: https://helm.sh/docs/intro/quickstart/
...
//
+
{kubectl-docs-install}[Install and set up Kubectl] on your build host.

. Helm
//
+
Helm helps you manage Kubernetes applications.
Using Helm charts, you can define,  install, and upgrade complex Kubernetes applications.
//
+
{helm-docs-quickstart}[Install and set up Helm] on your build host.
...
. Before continuing, make sure that the {nvidia-org} kernel modules are not loaded on any of the Kubernetes worker nodes.
