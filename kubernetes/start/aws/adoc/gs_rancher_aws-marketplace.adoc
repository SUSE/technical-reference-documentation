...
The {offering} marketplace listing will deploy an automation node, which in turn, allows the administrator to deploy {platform1} within a new {eks_long} cluster.
