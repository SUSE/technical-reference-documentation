...
:productname: Official SUSE product/platform abbreviation with version (e.g., SLES 15 SP5, Rancher 2.7)
:platform1: Rancher by SUSE 2.7 ?? 
:otherproduct1: AWS Marketplace
:otherproduct2: Amazon Elastic Kubernetes Service
