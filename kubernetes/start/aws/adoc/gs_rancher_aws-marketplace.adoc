...
20.	Deployment should take about 20 minutes. Take note of the resources created for this new cluster environment and store the Cleanup commands in a safe place by generating the commands then scrolling down to download the zip file. You can also leave this tab open to use the Clean Resources button at your leisure. 
21.	Follow the instructions at the top of the page to access your new SUSE Rancher UI and reset your administrative password. Happy Ranching. 
22.	You should now promptly Terminate the Instance created for deployment automation, to improve security and save cost. 
23.	Your SUSE Rancher UI will let you know that Priority Support has not been activated. To purchase Priority Support for your SUSE Rancher Implementation, you can contact SUSE directly at aws@suse.com or purchase it via the AWS Marketplace offerings for your Geography via the suse-rancher link below. 
