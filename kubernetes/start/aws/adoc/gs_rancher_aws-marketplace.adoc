...
. In the AWS Console, navigate to EC2 > Instances and select the radio button for the newly creatde instance created which corresponds to the AMI ID and name this Instance so you can find it later.
+ 
