...
+ 
image::NAME1.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME2.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME3.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME4.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME5.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME7.png[DEFINITION, scaledwidth="85%", align="center"]

. Select the 'Region' and 'Subnet' you created previously and then 'Continue to Launch'
+ 
image::NAME8.png[DEFINITION, scaledwidth="85%", align="center"]

. On the 'Congratulations' page, take note of the EC2 AMI ID. 
+ 
image::NAME9.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME10.png[DEFINITION, scaledwidth="85%", align="center"]

. We recommending naming this Instance so you can find it later. 
+ 
image::NAME11.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME12.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME13.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME14.png[DEFINITION, scaledwidth="85%", align="center"]

. Return to the SUSE Rancher Setup UI tab and click Next. 
+ 
image::NAME15.png[DEFINITION, scaledwidth="85%", align="center"]

. Policy Simulator verifies all permissions. Click Next. 
+ 
image::NAME16.png[DEFINITION, scaledwidth="85%", align="center"]

. Choose the region for deploying your EKS Management Cluster and click Next. 
+ 
image::NAME17.png[DEFINITION, scaledwidth="85%", align="center"]

. Choose your management cluster size. Small will work for most scenarios. Click Next. 
+ 
image::NAME18.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME19.png[DEFINITION, scaledwidth="85%", align="center"]

. Take note of the URL which SUSE Rancher will be served at and click next. Deployment occurs. 
+ 
image::NAME20.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME21.png[DEFINITION, scaledwidth="85%", align="center"]
...
+ 
image::NAME24.png[DEFINITION, scaledwidth="85%", align="center"]
