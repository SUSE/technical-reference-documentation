...
. Deployment should take about 20 minutes. Take note of the resources created for this new cluster environment and store the 'Clean resources' commands in a safe place by generating the commands then scrolling down to download the zip file. You can also leave this tab open to use the Clean Resources button at your leisure. 
+ 
...
. You can now use HTTPS in your browser to naviate to the FQDN provider during setup.
