...
. Return to the {otherproduct1} UI and click __Next__. 
+ 
#image::aws-mp-rancher-.png[DEFINITION, scaledwidth="85%", align="center"]
+
...
. Choose the region for deploying your EKS management cluster and click __Next__. 
+ 
#image::aws-mp-rancher-.png[DEFINITION, scaledwidth="85%", align="center"]

. Choose your management cluster size and click __Next__.
'Small' will work for most scenarios.
+ 
#image::aws-mp-rancher-.png[DEFINITION, scaledwidth="85%", align="center"]

. Choose a hostname for the Rancher UI, which will be installed onto your new EKS cluster.
Enter the FQDN including the R53 domain name you created.
Example: rancher.exampledomain.com.
{otherproduct1} will go build the EKS cluster and install {productname} into it using HELM.
+ 
#image::aws-mp-rancher-.png[DEFINITION, scaledwidth="85%", align="center"]

. Take note of the URL which SUSE Rancher will be served at and click next.
Deployment occurs. 
+ 
#image::aws-mp-rancher-.png[DEFINITION, scaledwidth="85%", align="center"]
