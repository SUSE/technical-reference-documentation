...
In this getting started guide you walk through installation of {productname} on {eks_long} using the {offering} offering in the {market}, enabling you to manage all of your downstream clusters wherever a routable API address exists.
...
In this document, you learn how to launch {platform1} from the {market} listing.
