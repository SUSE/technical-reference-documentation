...
* link:{modelCiscoUCS-C240SDURL}[{an_Cisco} {an_CiscoUCS} {modelCiscoUCS-C240SD}] is a high-performance compute solution in a dense 2-socket, 2-Rack-Unit, 22” form-factor to handle the most critical real-time compute applications. This front-access server can be deployed as stand-alone servers or as part of a {an_Cisco} {pn_CiscoUCS} ({an_Cisco} {an_CiscoUCS}) to deliver an exceptional management experience for a variety of applications by:
