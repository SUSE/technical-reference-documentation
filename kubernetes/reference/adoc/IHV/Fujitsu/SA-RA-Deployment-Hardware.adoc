...
** Use the Discover function to link {pn_Rancher} and {vn_Fujitsu} {vn_HPE_ComposerTech} to see all of the available nodes that can be assigned to to their respective roles:
