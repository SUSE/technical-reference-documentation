...
ifdef::Production[has tips on migration toward <<g-production>>,]
...
ifdef::Production[having considerations on migration toward <<g-production>>,]
...
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_Rancher}-{an_K3s}-{an_SLEMicro}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_Rancher}-{an_K3s}-{an_SLEMicro}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_Rancher}-{an_K3s}-{an_SLEMicro}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_Rancher}-{an_K3s}-{an_SLES}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_Rancher}-{an_K3s}-{an_SLES}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_Rancher}-{an_K3s}-{an_SLES}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_Rancher}-{an_RKE1}1-{an_SLES}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_Rancher}-{an_RKE}1-{an_SLES}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_Rancher}-{an_RKE}1-{an_SLES}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_Rancher}-{an_RKE2}-{an_SLES}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_Rancher}-{an_RKE2}-{an_SLES}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_Rancher}-{an_RKE2}-{an_SLES}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::layerSLEMicro[]
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_K3s}-{an_SLEMicro}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_K3s}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_K3s}-{an_SLEMicro}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_K3s}-{an_SLEMicro}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::layerSLES[]
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_K3s}-{an_SLES}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_K3s}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_K3s}-{an_SLES}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_K3s}-{an_SLES}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::layerSLEMicro[]
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_RKE1}1-{an_SLEMicro}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_RKE1}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_RKE1}1-{an_SLEMicro}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_RKE1}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_RKE1}1-{an_SLEMicro}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_RKE1}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::layerSLES[]
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_RKE1}1-{an_SLES}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_RKE1}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_RKE1}1-{an_SLES}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_RKE1}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_RKE1}1-{an_SLES}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_RKE1}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::layerSLEMicro[]
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_RKE2}-{an_SLEMicro}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_RKE2}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_RKE2}-{an_SLEMicro}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_RKE2}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_RKE2}-{an_SLEMicro}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_RKE2}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
...
ifdef::layerSLES[]
ifdef::iIHV+IHV-Ampere[]
image::rc-{an_RKE2}-{an_SLES}_{an_Ampere}_deployment.png[title="Deployment Stack - {pn_RKE2}", scaledwidth=80%]
endif::iIHV+IHV-Ampere[]
ifdef::iIHV+IHV-Cisco[]
...
ifdef::iIHV+IHV-HPQ[]
image::rc-{an_RKE2}-{an_SLES}_{an_HPQ}_deployment.png[title="Deployment Stack - {pn_RKE2}", scaledwidth=80%]
endif::iIHV+IHV-HPQ[]
ifdef::iIHV+IHV-LNVGY[]
image::rc-{an_RKE2}-{an_SLES}_{an_LNVGY}_deployment.png[title="Deployment Stack - {pn_RKE2}", scaledwidth=80%]
endif::iIHV+IHV-LNVGY[]
ifdef::iIHV+IHV-SMCi[]
