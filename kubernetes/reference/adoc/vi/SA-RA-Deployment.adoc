...
ifdef::layerSLEMicro[]
ifdef::iIHV+IHV-Cisco[]
image::rc-{an_K3s}-{an_SLEMicro}_{an_Cisco}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Cisco[]
ifdef::iIHV+IHV-DELL[]
image::rc-{an_K3s}-{an_SLEMicro}_{an_Dell}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-DELL[]
ifdef::iIHV+IHV-HPE[]
image::rc-{an_K3s}-{an_SLEMicro}_{an_HPE}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPE[]
ifdef::iIHV+IHV-Supermicro[]
image::rc-{an_K3s}-{an_SLEMicro}_{an_SMCi}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Supermicro[]
endif::layerSLEMicro[]

ifdef::layerSLES[]
ifdef::iIHV+IHV-Cisco[]
image::rc-{an_K3s}-{an_SLES}_{an_Cisco}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Cisco[]
ifdef::iIHV+IHV-DELL[]
image::rc-{an_K3s}-{an_SLES}_{an_Dell}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-DELL[]
ifdef::iIHV+IHV-HPE[]
image::rc-{an_K3s}-{an_SLES}_{an_HPE}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPE[]
ifdef::iIHV+IHV-Supermicro[]
image::rc-{an_K3s}-{an_SLES}_{an_SMCi}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Supermicro[]
image::rc-{an_K3s}-{an_SLES}_deployment.png[title="Deployment Stack - {pn_K3s}", scaledwidth=80%]
endif::layerSLES[]
...
ifdef::layerSLEMicro[]
ifdef::iIHV+IHV-Cisco[]
image::rc-{an_RKE1}1-{an_SLEMicro}_{an_Cisco}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Cisco[]
ifdef::iIHV+IHV-DELL[]
image::rc-{an_RKE1}1-{an_SLEMicro}_{an_Dell}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-DELL[]
ifdef::iIHV+IHV-HPE[]
image::rc-{an_RKE1}1-{an_SLEMicro}_{an_HPE}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPE[]
ifdef::iIHV+IHV-Supermicro[]
image::rc-{an_RKE1}1-{an_SLEMicro}_{an_SMCi}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Supermicro[]
endif::layerSLEMicro[]

ifdef::layerSLES[]
ifdef::iIHV+IHV-Cisco[]
image::rc-{an_RKE1}1-{an_SLES}_{an_Cisco}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Cisco[]
ifdef::iIHV+IHV-DELL[]
image::rc-{an_RKE1}1-{an_SLES}_{an_Dell}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-DELL[]
ifdef::iIHV+IHV-HPE[]
image::rc-{an_RKE1}1-{an_SLES}_{an_HPE}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPE[]
ifdef::iIHV+IHV-Supermicro[]
image::rc-{an_RKE1}1-{an_SLES}_{an_SMCi}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Supermicro[]
endif::layerSLES[]
...
ifdef::layerSLEMicro[]
ifdef::iIHV+IHV-Cisco[]
image::rc-{an_RKE2}-{an_SLEMicro}_{an_Cisco}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Cisco[]
ifdef::iIHV+IHV-DELL[]
image::rc-{an_RKE2}-{an_SLEMicro}_{an_Dell}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-DELL[]
ifdef::iIHV+IHV-HPE[]
image::rc-{an_RKE2}-{an_SLEMicro}_{an_HPE}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPE[]
ifdef::iIHV+IHV-Supermicro[]
image::rc-{an_RKE2}-{an_SLEMicro}_{an_SMCi}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Supermicro[]
endif::layerSLEMicro[]

ifdef::layerSLES[]
ifdef::iIHV+IHV-Cisco[]
image::rc-{an_RKE2}-{an_SLES}_{an_Cisco}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Cisco[]
ifdef::iIHV+IHV-DELL[]
image::rc-{an_RKE2}-{an_SLES}_{an_Dell}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-DELL[]
ifdef::iIHV+IHV-HPE[]
image::rc-{an_RKE2}-{an_SLES}_{an_HPE}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-HPE[]
ifdef::iIHV+IHV-Supermicro[]
image::rc-{an_RKE2}-{an_SLES}_{an_SMCi}_deployment.png[title="Deployment Stack - {pn_Rancher}", scaledwidth=80%]
endif::iIHV+IHV-Supermicro[]
endif::layerSLES[]
