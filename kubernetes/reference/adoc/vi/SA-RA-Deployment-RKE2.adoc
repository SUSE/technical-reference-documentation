...
. Identify the appropriate, desired version of the {pn_RKE2} (e.g. vX.YY.ZZ+rke2rV) by reviewing
+
...
ifdef::focusRKE2[]
// Next Steps::
After this successful deployment of the {pn_RKE2} solution, review the link:{pn_RKE2_DocURL}[product documentation] for details on how to directly utilize this Kubernetes cluster. Furthermore, by reviewing the {pn_Rancher} link:{pn_Rancher_DocURL}[product documentation] this solution can also be:
