...
ifdef::focusRancher[]
* With {pn_Rancher}, the digital transformation to containerized applications can be extended, in a distributed computing context, to benefit from the ability both to manage many target clusters, for each of the respective user bases, and to facilitate the actual workload deployments.
endif::focusRancher[]
ifdef::focusK3s[]
