...
ifdef::RC[:title: {title} of {pn_K3s}]
ifdef::RI[:title: {title} of {pn_K3s}]
ifdef::GS[:title: {title} of {pn_K3s}]
endif::focusK3s[]

ifdef::focusRKE1[]
:productname: {pn_RKE1} {pn_RKE1_Version}
ifdef::RC[:title: {title} of {pn_RKE1}]
ifdef::RI[:title: {title} of {pn_RKE1}]
ifdef::GS[:title: {title} of {pn_RKE1}]
endif::focusRKE1[]

ifdef::focusRKE2[]
:productname: {pn_RKE1} {pn_RKE1_Version}
ifdef::RC[:title: {title} of {pn_RKE2}]
ifdef::RI[:title: {title} of {pn_RKE2}]
ifdef::GS[:title: {title} of {pn_RKE2}]
endif::focusRKE2[]
...
ifdef::RC[]
:subtitle: Reference Configuration : Including Integration Layers from
ifdef::iIHV[]
