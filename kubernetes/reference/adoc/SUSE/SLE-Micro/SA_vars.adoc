...
:pn_SLEMicro_ReleaseNotes: https://www.suse.com/releasenotes/x86_64/SLE-Micro/5.5/
// :pn_SLEMicro_DocURL: https://documentation.suse.com/sle-micro/5.1/
:pn_SLEMicro_DocURL: https://documentation.suse.com/sle-micro/5.5/
...
:pn_SLEMicro_InstallationDocURL: https://documentation.suse.com/sle-micro/5.5/single-html/SLE-Micro-deployment/#book-deployment-slemicro
// :pn_SLEMicro_AutoYaSTDocURL: https://documentation.suse.com/sle-micro/5.1/single-html/SLE-Micro-autoyast/#book-autoyast
:pn_SLEMicro_AutoYaSTDocURL: https://documentation.suse.com/sle-micro/5.5/single-html/SLE-Micro-autoyast/#book-autoyast
