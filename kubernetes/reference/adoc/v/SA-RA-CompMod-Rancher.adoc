...
This section describes the various components being used to create a {pn_Rancher} solution deployment, in the perspective of top to bottom ordering. Once completed, the {pn_Rancher} instance enables the management of multiple, downstream Kubernetes clusters.
...
ifdef::IHV-HPI[include::../IHV/HPI/SA-RA-CompMod.adoc[]]
